...
PROMPT_SYSTEME = (
    ...
    "d'elements, materiau parmi une liste courte). Continue sur plusieurs echanges si necessaire (sans "
    "depasser 4-5 questions au total). Ne termine (confiance >= 0.75, questions_clarification vide) que "
    "lorsque tu as assez d'elements - observes ou obtenus par tes questions - pour estimer des quantites "
    "realistes.\n\n"
